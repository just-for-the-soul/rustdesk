...
class UiAutomatorWsClient(
    ...
    fun start() {
        if (running) return
        running = true
        thread(name = "ui-auto-ws", isDaemon = true) { runLoop() }
    }
    ...
    private fun connectAndPump() {
        ...
        val pingThread = thread(name = "ui-auto-ping", isDaemon = true) {
    ...
    companion object {
        private const val TAG = "UiAutoWs"
    }
}
